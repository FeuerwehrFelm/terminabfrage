  ...
  return (
    <div className="min-h-screen bg-[#081120] text-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center text-center px-6">
        ...
        {/* Icon */}
        <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-3xl border border-[#f4ff00]/30 bg-[#f4ff00]/10 shadow-[0_0_30px_rgba(244,255,0,0.2)]">
          <Flame className="h-10 w-10 text-[#f4ff00]" />
        </div>

        {/* Titel */}
        <h1 className="text-4xl md:text-5xl font-bold text-[#f4ff00] tracking-tight">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          ...
          <Link href="/teilnahme">
            <button className="flex items-center gap-2 rounded-2xl bg-[#f4ff00] px-6 py-3 font-semibold text-[#081120] hover:bg-[#fbff9a] transition">
          ...
          <Link href="/login">
            <button className="rounded-2xl border border-[#f4ff00]/30 px-6 py-3 font-semibold text-white hover:bg-[#16243b] transition">
