...
function token(array $claims,string $secret): string { $payload=b64e(json_encode($claims+['exp'=>time()+60*60*12],JSON_UNESCAPED_UNICODE)); return $payload.'.'.b64e(hash_hmac('sha256',$payload,$secret,true)); }
